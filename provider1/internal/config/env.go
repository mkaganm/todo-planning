...
type envConfigs struct {
	...
	Provider1Url    string `mapstructure:"PROVIDER1_URL"`
}

// loadEnvVariables loads all environment variables from the provider1.env file
